...
@section('content')
                ...
                <div class="col-md-4">
                                ...
                                @foreach ($communications as $communication)
                                    <a href="#" class="list-group-item list-group-item-action">
                                        <div class="d-flex w-100 justify-content-between">
                                            {{-- <h5 class="mb-1">❓ {{ $communication->subject }}</h5> --}}
                    ...
                    <div class="card">
                        <div class="card-header bg-success">
                            ...
                            <a class="btn btn-light btn-sm" href={{ route('tickets.create', session('client_id')) }}>
                                + New
                            </a>
                        </div>
                        <div class="card-body">
    ...
    @else
        <div style='min-height: 700px;'>
            <h1 class="d-flex justify-content-center align-items-center p-4">
                <span class="text-center m-4 p-4">You don't have any project now.</span>
            </h1>
        </div>
    @endif
@endsection
